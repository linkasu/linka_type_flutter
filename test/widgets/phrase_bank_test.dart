...
void main() {
  group('PhraseBank', () {
    ...
    setUp(() {
      ...
      testStatements = [
        Statement(id: 'stmt1', title: 'Фраза 1', categoryId: 'cat1', userId: 'user1'),
        Statement(id: 'stmt2', title: 'Фраза 2', categoryId: 'cat1', userId: 'user1'),
        Statement(id: 'stmt3', title: 'Фраза 3', categoryId: 'cat2', userId: 'user1'),
      ];
    });

    testWidgets('отображает список категорий когда selectedCategory равен null', (WidgetTester tester) async {
    ...
    testWidgets('отображает список фраз когда выбрана категория', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: PhraseBank(
    ...
    testWidgets('показывает кнопку добавления категории в режиме категорий', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: PhraseBank(
    ...
    testWidgets('показывает кнопку добавления фразы в режиме фраз', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: PhraseBank(
    ...
    testWidgets('показывает кнопку назад в режиме фраз', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: PhraseBank(
    ...
    testWidgets('вызывает onCategorySelected при нажатии на кнопку назад', (WidgetTester tester) async {
    ...
    testWidgets('вызывает onAddCategory при нажатии на кнопку добавления в режиме категорий', (WidgetTester tester) async {
    ...
    testWidgets('вызывает onAddStatement при нажатии на кнопку добавления в режиме фраз', (WidgetTester tester) async {
    ...
    testWidgets('показывает сообщение об отсутствии категорий', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: PhraseBank(
    ...
    testWidgets('показывает сообщение об отсутствии фраз в категории', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: PhraseBank(
    ...
    testWidgets('правильно подсчитывает количество фраз в категории', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: PhraseBank(
